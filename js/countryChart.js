...
function createCountryChart(svg, color, chartScale, offsetX, offsetY) {
  
    ////////////////////////////////////////////////////////////
    ///////////////////// Read in data /////////////////////////
    ////////////////////////////////////////////////////////////
    
    d3.json('data/medals_country.json', function (error, data) {
      ...
      .on("mouseover", function(d) { showTooltipCountry(d, color); })
    ...
    ////////////////////////////////////////////////////////////
      ...
      .attr("dy", "0.5em")
      .text("Olympic medals per country")
